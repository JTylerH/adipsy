...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		wp_register_script( 'lightslider-js', get_stylesheet_directory_uri() . '/library/js/libs/jquery.matchHeight-min.js', array( 'jquery' ), '', true );
