...
<section class="bg-w">
  <div class="container-fluid">
    <div class="get-involved">
      <a href="<?php bloginfo('url'); ?>/about-us/founders/" class="get-involved-block" style="background-image:url(<?php echo get_template_directory_uri(); ?>/library/img/journey.jpg);">
      ...
      <a href="<?php bloginfo('url'); ?>/donate" class="get-involved-block" style="background-image:url(<?php echo get_template_directory_uri(); ?>/library/img/donate.jpg);">
      ...
      <a href="<?php bloginfo('url'); ?>/volunteer" class="get-involved-block" style="background-image:url(<?php echo get_template_directory_uri(); ?>/library/img/volunteer.jpg);">
